...
void Stack_Init(Stack *stack)
{
	if (stack == NULL)
	{
		//pokud stack == NULL, vrátí se chyba a funkce skončí
...
{
	//funkce vrátí -1, pokud je zásobník prázdný
...
void Stack_Top(const Stack *stack, char *dataPtr)
{
	...
	{
		//pokud je zásobník prázdný, vrátí se chyba a funkce skončí
		Stack_Error(SERR_TOP);
		return;
	}
	else
	{
		//pokud zásobník není prázdný, ukladáme hodnotu na vrcholu zásobníku na dataPtr
...
{
	//pokud zásobník není prázdný, odstraníme prvek z vrcholu zásobníku
	if (!Stack_IsEmpty(stack))
		stack->topIndex--;
}
...
void Stack_Push(Stack *stack, char data)
{
	...
	{
		//pokud je zásobník plný, vrátí se chyba a funkce skončí
		Stack_Error(SERR_PUSH);
		return;
	}
	else
	{
		//zvětšíme velikost zásobníku a přiřadíme hodnotu data
		stack->topIndex++;
